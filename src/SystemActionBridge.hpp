...
public:
    ...
    Q_INVOKABLE bool applyTimeZone(const QString &timeZone);
...
private:
    ...
    bool syncHardwareClockIfAvailable(QString *errorMessage);
    QString normalizedPowerError(const QString &errorMessage) const;
    void refreshFanMode();
